	...
	protected function getInput()
	{
		...
		$html[] = JHtml::_('bootstrap.renderModal',
			...
			array(
				...
				'footer' =>
					'<button type="button" class="btn perfect-image-close" data-dismiss="modal" aria-hidden="true">' . JText::_("JLIB_HTML_BEHAVIOR_CLOSE") . '</button>' .
					'<button type="button" class="btn btn-success perfect-image-save" data-dismiss="modal" aria-hidden="true">' . JText::_("JSAVE") . '</button>'
			),
			$layout->render($data)
		);
