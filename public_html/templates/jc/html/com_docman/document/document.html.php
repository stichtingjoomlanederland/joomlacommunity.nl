...
<div class="docman_document well" itemscope itemtype="http://schema.org/CreativeWork">
    <div class="row">
        <div class="col-md-7">
			<? // Header ?>
        ...
        <div class="col-md-5">
            <div class="panel panel-downloads">
                ...
                <ul class="list-group panel-collapse in" id="joomla_3-1-5-stable-full_package-zip">
					<? // Tags ?>

					<? if ($params->show_document_tags && $document->tag_list): ?>
                        <li class="list-group-item">
                        <span class="info">
	                        <?php echo JLayoutHelper::render('template.snippet-versions', explode(', ', $document->tag_list)); ?>
                        </span>
                            Geschikt voor
                        </li>
					<? endif; ?>
            ...
            <time itemprop="dateModified" datetime="<?= $document->modified_on ?>">
                ...
                --></span>
					...
					<? if ($params->show_document_hits && $document->hits): ?>
                        <li class="list-group-item">
                            <span class="info"><?= $document->hits ?></span>
                    ...
                    <li class="list-group-item">
						...
						<? if (!object('user')->isAuthentic() || $document->canPerform('download')): ?>
                            ...
                            <a class="btn btn-large btn-success btn-block docman_download__button docman_track_download"
