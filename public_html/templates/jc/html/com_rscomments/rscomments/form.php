			...
			<div class="rscomments-accordion-content<?php echo $this->config->show_form ? ' open' : ''; ?>" id="rscomments-accordion-content-<?php echo $this->hash; ?>"<?php echo !$this->config->show_form ? ' style="display: none;"' : ''; ?>>
				...
				<div class="row-fluid">
					<div class="rscomments-comment-area control-group">
						<div class="controls">
							<textarea data-rsc-task="commentform" class="input-block-level required form-control" name="jform[comment]" rows="5" maxlength="<?php echo $clength; ?>" placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_COMMENT'); ?>"></textarea>
						</div>
					</div>
				</div>
					...
					<div class="row-fluid">
						<div class="control-group">
							<p class="char-left muted">
								<span class="comment_length"><?php echo $clength; ?></span> <?php echo JText::_('COM_RSCOMMENTS_CHARS_LEFT'); ?>
							</p>
						</div>
					</div>
				<?php } ?>
