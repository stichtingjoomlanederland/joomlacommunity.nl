            ...
            <div class="rscomments-accordion-content<?php echo $this->config->show_form ? ' open' : ''; ?>" id="rscomments-accordion-content"<?php echo !$this->config->show_form ? ' style="display: none;"' : ''; ?>>
				...
				<?php if ($this->config->enable_location) { ?>
                    <div class="row">
                        <div class="control-group rsc_location_container">
                            ...
                            <input type="text" class="col-md-12" id="rsc_location" name="jform[location]" value="" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_LOCATION'); ?>"<?php } ?> />
                        </div>
                    </div>
				<?php } ?>
                ...
                <div class="row">
                    <div class="form-group col-md-12" id="rscomments-comment-area">
                        <div>
                            <textarea id="rsc_comment" class="input-block-level required form-control" name="jform[comment]" rows="5" onkeydown="rsc_comment_cnt('rsc_comment','commentlen','<?php echo $clength; ?>');" onkeyup="rsc_comment_cnt('rsc_comment','commentlen','<?php echo $clength; ?>');" maxlength="<?php echo $clength; ?>" placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_COMMENT'); ?>"></textarea>
                        </div>
                    </div>
