...
<div id="rsepro-upcoming-module">
	...
	<ul class="rsepro_upcoming<?php echo $suffix; ?> row-fluid">
		...
		<li class="clearfix span<?php echo 12 / $columns; ?>">
			...
			<a <?php echo $open; ?> href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&layout=show&id='.rseventsproHelper::sef($event->id,$event->name),true,$itemid); ?>"><?php echo $event->name; ?></a> <?php if ($event->published == 3) { ?><small class="text-error">(<?php echo JText::_('MOD_RSEVENTSPRO_FEATURED_CANCELED'); ?>)</small><?php } ?>
			<br />
