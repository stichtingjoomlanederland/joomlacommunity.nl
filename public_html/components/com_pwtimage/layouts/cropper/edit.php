...
if (isset($showSavePath) && $showSavePath)
{
	...
	$destinationOptions = [];
	$optionsList        = ['default', 'select', 'custom'];

	if ((int) $disableDefaultFolder === 1)
	{
		$optionsList = array('select', 'custom');
	}
...
Factory::getDocument()->addScriptDeclaration(<<<JS
	...
	jQuery(document).ready(function (){
	    if ({$showSavePath}) {
			...
			pwtImage.loadSelectFolders('{$sourcePath}');
		}
		...
		<?php if (isset($showSavePath) && $showSavePath)
            ...
            <div class="pwt-input-group pwt-input-group--responsive pwt-image-modify">
                <div class="pwt-input-group__row">
                    ...
                    <div
                            class="pwt-input-group__addon pwt-input-group__flex-item js-sourcePath"><?php echo $sourcePath; ?>
                        /
                    </div>
                </div>
                <div class="pwt-input-group__row pwt-input-group__row--flex">
					<?php if ($showSavePathSelect)
						:
						?>
                        <div id="<?php echo $modalId; ?>_selectFolder"
                             class="pwt-input-group__choices pwt-filename-input is-hidden">
							<?php echo HTMLHelper::_('select.genericlist', [], 'selectFolder', 'folder-choices', 'value', 'text', null, $modalId . '_selectedFolderOptions'); ?>
                        </div>
					<?php endif; ?>
                    <div id="<?php echo $modalId; ?>_enterFolder"
                         class="pwt-input-group__input pwt-input-group__input--first is-visible">
                        <input class="pwt-form-control js-pwt-image-subPath" type="input" name="subPath"
                               id="<?php echo $modalId; ?>_subPath" value="<?php echo $subPath; ?>" disabled/>
                    </div>
                    <div class="pwt-input-group__input">
                        <input class="pwt-form-control js-pwt-image-targetfile" id="pwt-image-targetFile" type="text"
                               name="pwt-image-targetFile" value="">
                    </div>
                </div>
            </div><!-- .pwt-input-group -->
		<?php else
            ...
            <input type="hidden" class="js-pwt-image-targetfile" id="pwt-image-targetFile" name="pwt-image-targetFile"
                   value=""/>
		<?php endif; ?>
					...
					<?php if ($showTools && $canEdit)
                        ...
                        <div class="pwt-form-group">
							<?php if ($wysiwyg)
								:
								?>
                                <button class="pwt-button pwt-button--primary js-button-save-new"
                                        onclick="return pwtImage.saveImage('<?php echo $modalId; ?>', true);">
							...
							if (!$toCanvas)
								:
								?>
                                <button type="button" class="pwt-button"
                                        onclick="pwtImage.cancelImage('<?php echo $modalId; ?>');">
                                    ...
                                    <div class="pwt-button-group">
                                        <div class="pwt-button-group__addon">
                                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <g transform="matrix(-1.00008,0,-0,1.00008,24.002,-2.00088)">
                                                    <path
                                                            d="M24,14C24,15.625 23.682,17.177 23.047,18.656C22.412,20.135 21.558,21.411 20.485,22.484C19.412,23.557 18.136,24.411 16.657,25.046C15.178,25.681 13.626,25.998 12.001,25.999C10.209,25.999 8.506,25.621 6.892,24.866C5.278,24.111 3.903,23.046 2.767,21.671C2.694,21.567 2.66,21.45 2.665,21.319C2.67,21.188 2.714,21.082 2.798,20.999L4.939,18.843C5.043,18.749 5.173,18.702 5.33,18.702C5.497,18.723 5.616,18.785 5.689,18.889C6.45,19.878 7.382,20.644 8.486,21.186C9.59,21.728 10.762,21.999 12.002,21.998C13.085,21.998 14.119,21.787 15.104,21.365C16.089,20.943 16.94,20.373 17.659,19.654C18.378,18.935 18.948,18.084 19.37,17.099C19.792,16.114 20.003,15.08 20.003,13.997C20.003,12.914 19.792,11.88 19.37,10.895C18.948,9.91 18.378,9.059 17.659,8.34C16.94,7.621 16.089,7.051 15.104,6.629C14.119,6.207 13.085,5.996 12.002,5.996C10.981,5.996 10.002,6.181 9.064,6.551C8.126,6.921 7.293,7.45 6.564,8.137L8.705,10.293C9.028,10.606 9.101,10.965 8.924,11.371C8.747,11.788 8.439,11.996 8.002,11.996L1.002,11.996C0.731,11.996 0.497,11.897 0.299,11.699C0.101,11.501 0.002,11.267 0.002,10.996L0.002,3.996C0.002,3.559 0.21,3.251 0.627,3.074C1.033,2.897 1.392,2.97 1.705,3.293L3.736,5.309C4.851,4.257 6.124,3.442 7.556,2.864C8.988,2.286 10.47,1.997 12.001,1.997C13.626,1.997 15.178,2.315 16.657,2.95C18.136,3.585 19.412,4.439 20.485,5.512C21.558,6.585 22.412,7.861 23.047,9.34C23.682,10.819 23.999,12.371 24,13.996L24,14Z"/>
                                                </g>
                                            </svg>
                                    ...
                                    <div class="pwt-button-group">
                                        <div class="pwt-button-group__addon">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 985.00279 983.75235">
                                                ...
                                                <g transform="translate(-1206.5509,-3537.7299)">
                                                    <path
                                                            d="m 1292.4888,4436.7901 -84.6852,-84.6921 85.0012,-84.9943 85.0011,-84.9942 84.6852,84.6852 84.6852,84.6852 -85.0011,85.0011 -85.0011,85.0012 -84.6853,-84.6921 z m 321.2368,-322.5133 -407.1747,-407.1761 84.6909,-84.6841 84.691,-84.6841 407.2007,407.2022 407.2009,407.2023 -9.3904,9.3276 c -5.1647,5.1303 -9.3903,9.9063 -9.3903,10.6135 0,1.6368 -128.9657,130.6518 -130.6018,130.6518 -0.6699,0 -5.4555,4.2127 -10.6347,9.3616 l -9.4168,9.3615 -407.1748,-407.1762 z m 322.828,-322.172 -84.368,-84.375 84.9931,-85 84.9931,-85 84.6909,84.6841 84.691,84.6841 -84.6841,84.6909 c -46.5762,46.58 -84.9684,84.6909 -85.316,84.6909 -0.3475,0 -38.5975,-37.9687 -85,-84.375 z"/>
                                                </g>
                                            </svg>
                                            <span
                                                    class="visually-hidden"><?php echo Text::_('COM_PWTIMAGE_RATIO'); ?></span>
                                        </div>
										<?php if ($ratio)
											:
                                        ...
                                        <div class="pwt-button-group__button">
                                            ...
                                            >
                                                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path
                                                            d="M14.768,9.693l0,0.923c0,0.125 -0.045,0.233 -0.136,0.325c-0.091,0.091 -0.2,0.137 -0.325,0.136l-8.308,0c-0.125,0 -0.233,-0.045 -0.325,-0.136c-0.092,-0.091 -0.137,-0.2 -0.136,-0.325l0,-0.923c0,-0.125 0.045,-0.233 0.136,-0.325c0.091,-0.092 0.2,-0.137 0.325,-0.137l8.308,0c0.125,0 0.233,0.046 0.325,0.137c0.091,0.091 0.137,0.199 0.136,0.325Zm1.846,0.461c0,-1.779 -0.632,-3.3 -1.896,-4.564c-1.265,-1.264 -2.787,-1.897 -4.565,-1.897c-1.779,-0.001 -3.3,0.631 -4.565,1.897c-1.264,1.265 -1.897,2.786 -1.897,4.564c0,1.778 0.633,3.3 1.897,4.565c1.265,1.265 2.786,1.897 4.565,1.897c1.778,-0.001 3.3,-0.633 4.565,-1.897c1.264,-1.264 1.896,-2.786 1.896,-4.565Zm7.385,12c0,0.51 -0.18,0.945 -0.541,1.306c-0.36,0.36 -0.796,0.54 -1.305,0.54c-0.519,0 -0.952,-0.182 -1.298,-0.548l-4.947,-4.933c-1.721,1.192 -3.639,1.788 -5.754,1.788c-1.375,0 -2.69,-0.267 -3.944,-0.8c-1.255,-0.534 -2.337,-1.255 -3.246,-2.164c-0.909,-0.909 -1.63,-1.991 -2.164,-3.245c-0.533,-1.255 -0.8,-2.57 -0.8,-3.945c0,-1.374 0.267,-2.689 0.8,-3.944c0.534,-1.255 1.255,-2.337 2.164,-3.245c0.909,-0.909 1.991,-1.631 3.246,-2.164c1.254,-0.534 2.569,-0.8 3.944,-0.8c1.375,0 2.689,0.266 3.944,0.8c1.255,0.533 2.337,1.255 3.246,2.164c0.909,0.908 1.63,1.99 2.163,3.245c0.534,1.255 0.801,2.57 0.801,3.944c0,2.115 -0.596,4.034 -1.788,5.755l4.946,4.947c0.356,0.355 0.534,0.788 0.534,1.297l-0.001,0.002Z"/>
                                                </svg>
                                                <span
                                                        class="visually-hidden"><?php echo Text::_('COM_PWTIMAGE_ZOOM_OUT'); ?></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="pwt-grid__content">
					...
					<?php if ($showTools && $canEdit)
                        ...
                        <div class="pwt-form-group pwt-image-modify">
							...
							<?php endif; ?>
                            <button type="button" onclick="pwtImage.directToCanvas(this); return false;"
                                    class="pwt-button js-edit-image-button">
