...
<div class="clearfix">
	<a href="<?php echo $this->prev; ?>" class="<?php echo RSEventsproAdapterGrid::styles(array('btn', 'pull-left')); ?>"><i class="fa fa-chevron-left"></i> <?php echo JText::_('COM_RSEVENTSPRO_PREVIOUS_DAY'); ?></a>
	<a href="<?php echo $this->next; ?>" class="<?php echo RSEventsproAdapterGrid::styles(array('btn', 'pull-right')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_NEXT_DAY'); ?> <i class="fa fa-chevron-right"></i></a>
</div>
