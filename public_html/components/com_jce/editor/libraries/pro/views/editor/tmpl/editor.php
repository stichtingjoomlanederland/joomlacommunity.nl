...
<form onsubmit="return false;">
    ...
    <div class="actionPanel uk-modal-footer">
        <button class="revert uk-button"><i class="uk-icon-refresh uk-margin-small-right"></i><?php echo JText::_('WF_LABEL_REVERT'); ?></button>
        <button class="undo uk-button"><i class="uk-icon-undo uk-margin-small-right"></i><?php echo JText::_('WF_LABEL_UNDO'); ?></button>
        <button class="save uk-button uk-button-primary"><i class="uk-icon-check uk-margin-small-right"></i><?php echo JText::_('WF_LABEL_SAVE'); ?></button>
    </div>
