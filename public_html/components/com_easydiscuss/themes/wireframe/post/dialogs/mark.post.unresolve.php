...
<dialog>
    ...
    <content>
        ...
        <form data-form-response method="post" action="<?php echo JRoute::_('index.php');?>">
            ...
            <?php echo $this->html('form.hidden', 'posts', 'posts', 'unresolve');?>
        </form>        
    </content>
    <buttons>
        <button data-close-button type="button" class="btn btn-default btn-sm"><?php echo JText::_('COM_EASYDISCUSS_BUTTON_NO'); ?></button>
        <button data-submit-button type="button" class="btn btn-danger btn-sm"><?php echo JText::_('COM_EASYDISCUSS_BUTTON_YES_MARK_POST_UNRESOLVED'); ?></button>
    </buttons>
</dialog>
