...
<dialog>
	...
	<content>
		...
		<form data-form-response method="post" action="<?php echo JRoute::_('index.php');?>">
			...
			<?php echo $this->html('form.action', 'posts', 'posts', 'accept');?>
		</form>
	</content>
	<buttons>
		...
		<button data-submit-button type="button" class="ed-dialog-footer-content__btn t-text--primary"><?php echo JText::_('COM_EASYDISCUSS_BUTTON_YES_MARK_AS_ANSWER'); ?></button>
	</buttons>
</dialog>
