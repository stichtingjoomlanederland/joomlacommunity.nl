...
#ed .ed-toolbar__item--search select {border-color: <?php echo $this->config->get('layout_toolbarbordercolor', '#333333');?>; }
...
#ed .ed-toolbar .o-nav__item .ed-toolbar__link:not(.no-active-state):active { background-color: <?php echo $this->config->get('layout_toolbaractivecolor', '#5c5c5c')?>; }
