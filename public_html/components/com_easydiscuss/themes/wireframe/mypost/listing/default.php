...
?>
<div class="ed-my-posts">
	<div class="l-stack">
		<h2 class="o-title"><?php echo JText::_('COM_ED_MY_POSTS'); ?></h2>
		...
		<div class="ed-posts <?php echo !$posts ? 'is-empty' : '';?>" data-ed-list-wrapper>
			...
			<?php echo $this->html('card.emptyCard', 'far fa-newspaper', 'COM_ED_NO_POSTS_CREATED_YET'); ?>
		</div>
	</div>
</div>
