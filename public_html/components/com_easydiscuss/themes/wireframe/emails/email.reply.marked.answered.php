...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_REPLY_MARKED_ANSWERED', JText::sprintf('COM_EASYDISCUSS_EMAIL_TEMPLATE_YOUR_REPLY_MARKED_ANSWERED', $postTitle)); ?>
