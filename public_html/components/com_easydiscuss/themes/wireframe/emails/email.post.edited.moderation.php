...
<?php echo $this->html('email.heading', 'COM_ED_EMAILS_EDITED_DISCUSSION_REQUIRE_MODERATION', JText::sprintf('COM_ED_EMAILS_TEMPLATE_HAS_EDITED_DISCUSSION', $postAuthor, $postTitle, $postCategory)); ?>
