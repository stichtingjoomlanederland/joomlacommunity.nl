...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_REPORT_POSTED', JText::sprintf('COM_EASYDISCUSS_EMAIL_TEMPLATE_NEW_REPORT_POSTED_MESSAGE', $postTitle)); ?>
