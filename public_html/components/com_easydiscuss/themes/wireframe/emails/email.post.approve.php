...
?>
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAIL_TEMPLATE_NEW_' . $type . '_APPROVED', JText::sprintf('COM_EASYDISCUSS_NEW_' . $type . '_APPROVED', $postLink, $postTitle)); ?>
						...
						<tr>
							<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
	  							<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
									...
									<p><?php echo JText::_('COM_EASYDISCUSS_EMAILS_NEW_' . $type . '_APPROVED_NOTIFICATION'); ?></p>
								</div>
			  				</td>
						</tr>
	  					</table>
