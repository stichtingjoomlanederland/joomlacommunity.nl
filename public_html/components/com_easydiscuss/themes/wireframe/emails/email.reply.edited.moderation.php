...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_EDITED_REPLY_REQUIRE_MODERATION', JText::sprintf('COM_EASYDISCUSS_EMAILS_TEMPLATE_HAS_EDITED_REPLY', $replyAuthor, $postTitle)); ?>
						...
						<tr>
							<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
								<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
									...
									<p>
										<?php echo JText::sprintf('COM_EASYDISCUSS_EMAILS_EDITED_REPLY_MODERATED_NOTIFICATION', $replyAuthor); ?>
									</p>
								</div>
							</td>
						</tr>
