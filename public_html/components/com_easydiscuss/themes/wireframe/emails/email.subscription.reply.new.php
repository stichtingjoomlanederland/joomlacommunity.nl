...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_REPLY_ADDED', JText::sprintf('COM_EASYDISCUSS_EMAILTEMPLATE_REPLIED_TO_DISCUSSION', $replyAuthor, $postTitle)); ?>
