...
<?php echo $this->html('email.divider'); ?>
							...
							<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
								<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#626262;">
									<p>
										...
										<?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_TO_UNSUBSCRIBE');?> <a href="<?php echo $unsubscribeLink;?>" style="color: #4e72e2; text-decoration: none;"><?php echo JText::_('COM_EASYDISCUSS_EMAILTEMPLATE_CLICK_HERE');?></a>.
									</p>
									<a href="<?php echo $subscriptionsLink; ?>" style="color: #4e72e2; text-decoration: none;"><?php echo JText::_('COM_ED_MANAGE_YOUR_SUBSCRIPTION'); ?></a>
								</div>
							</td>
						</tr>
						</table>
