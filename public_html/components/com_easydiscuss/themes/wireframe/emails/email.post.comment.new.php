...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_COMMENT_POSTED', JText::sprintf('COM_EASYDISCUSS_EMAIL_TEMPLATE_NEW_COMMENT', $commentAuthor, $postTitle)); ?>
						...
						<tr>
							<td align="left" style="font-size:0px;padding:0;word-break:break-word;">
	  							<div style="font-family:'Roboto', Arial, sans-serif;font-size:16px;line-height:30px;text-align:left;color:#444444;">
									...
									<p><?php echo JText::sprintf('COM_EASYDISCUSS_EMAILS_NEW_COMMENT_NOTIFICATION', $commentAuthor, $postTitle); ?></p>
								</div>
			  				</td>
						</tr>
	  					</table>
