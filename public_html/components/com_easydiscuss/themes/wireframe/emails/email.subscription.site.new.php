...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_DISCUSSION_POSTED', JText::sprintf('COM_EASYDISCUSS_EMAILTEMPLATE_CREATED_NEW_DISCUSSION', $postAuthor, $postTitle, $postCategory)); ?>
