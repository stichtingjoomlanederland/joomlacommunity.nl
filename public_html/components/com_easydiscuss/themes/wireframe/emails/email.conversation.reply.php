...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_CONVERSATION_POSTED'); ?>
...
<?php echo $this->html('email.button', 'COM_EASYDISCUSS_EMAILTEMPLATE_READ_THIS_CONVERSATION', $conversationLink); ?>