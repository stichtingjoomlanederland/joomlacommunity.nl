...
<?php echo $this->html('email.heading', 'COM_EASYDISCUSS_EMAILS_NEW_REPLY_MARKED_UNRESOLVED', JText::sprintf('COM_EASYDISCUSS_EMAIL_TEMPLATE_MARKED_UNRESOLVED', $postTitle)); ?>
