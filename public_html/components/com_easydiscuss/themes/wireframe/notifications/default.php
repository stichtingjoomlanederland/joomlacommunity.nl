...
<div class="ed-noti">
	...
	<?php if ($notifications) { ?>
		<?php foreach ($notifications as $day => $data) { ?>
			<div class="ed-noti-list">
				<div class="ed-noti__date t-lg-mt--lg t-lg-mb--lg"><?php echo $day; ?></div>
				<?php foreach ($data as $item) { ?>

					<div data-ed-notifications-items class="ed-noti__item is-<?php echo $item->state == DISCUSS_NOTIFICATION_READ ? 'read' : 'unread';?>
		...
		<?php } ?>
	<?php } else { ?>
		<div class="ed-noti-empty-container t-lg-mt--xl is-empty">
			<div class="o-empty">
