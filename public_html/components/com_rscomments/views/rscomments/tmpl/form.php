...
<div class="rscomment-form well<?php if (isset($this->config->comment_form_position) && $this->config->comment_form_position) { ?> rscomment-form-top<?php } ?>">
	<form action="javascript:void(0)" data-rsc-task="form">
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(6); ?>">
				...
				<?php } ?>
				<div class="controls">
					<input <?php echo $this->disable; ?> type="text" class="span11 form-control required" id="rsc_name<?php echo $this->hash; ?>" name="jform[name]" value="<?php echo $this->user->get('name'); ?>" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_NAME').$required; ?>"<?php } ?> />
				</div>
			</div>
			<?php } ?>
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(6); ?>">
				...
				<?php } ?>
				<div class="controls">
					<input <?php echo $this->disable; ?> type="text" class="span11 form-control required" id="rsc_email<?php echo $this->hash; ?>" name="jform[email]" value="<?php echo $this->user->get('email'); ?>" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_EMAIL').$required; ?>"<?php } ?> />
				</div>
			</div>
			<?php } ?>
		</div>
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(6); ?>">
				...
				<?php } ?>
				<div class="controls">
					<input type="text" class="span11 form-control" id="rsc_subject<?php echo $this->hash; ?>" name="jform[subject]" value="" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_SUBJECT'); ?>"<?php } ?> />
				</div>
			</div>
			<?php } ?>
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(6); ?>">
				...
				<?php } ?>
				<div class="controls">
					<input type="text" class="span11 form-control" id="rsc_website<?php echo $this->hash; ?>" name="jform[website]" value="" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_WEBSITE'); ?>"<?php } ?> />
				</div>
			</div>
			<?php } ?>
		</div>
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			<div class="<?php echo RSCommentsAdapterGrid::column(12); ?>">
				<div class="control-group rsc_location_container">
					...
					<input data-rsc-task="searchaddress" type="text" class="span12 form-control" id="rsc_location<?php echo $this->hash; ?>" name="jform[location]" value="" size="45" <?php if (!$this->config->show_labels) { ?>placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_LOCATION'); ?>"<?php } ?> />
				</div>
			</div>
		</div>
		<?php } ?>
						...
						<div class="rscomment-comment-area">
							...
							<div class="rscomment-comment-area-actions">
								...
								<div class="btn-toolbar rscomments-close-preview" style="display:none;">
									<?php $btnClass = RSCommentsHelper::isJ4() ? 'btn btn-secondary' : 'btn btn-small'; ?>
									<a href="javascript:void(0);" data-rsc-task="closepreview" class="<?php echo $btnClass; ?> <?php echo RSTooltip::tooltipClass(); ?>" title="<?php echo RSTooltip::tooltipText(JText::_('COM_RSCOMMENTS_CLOSE_PREVIEW')); ?>"><i class="fa fa-times"></i></a>
								</div>
							</div>
							<?php } ?>
							
							<textarea data-rsc-task="commentform" class="input-block-level form-control required" name="jform[comment]" rows="5" maxlength="<?php echo $clength; ?>" placeholder="<?php echo JText::_('COM_RSCOMMENTS_COMMENT_COMMENT'); ?>"></textarea>
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(3); ?>">
				<div class="controls">
			...
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(9); ?> rsc-terms-container">
				<div class="controls">
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			<div class="control-group <?php echo RSCommentsAdapterGrid::column(9); ?>">
				<div class="controls">
					<label class="checkbox">
					...
					<div class="controls rsc-captcha-container">
						<div class="<?php echo RSCommentsAdapterGrid::column(5); ?>">
							...
							<img src="<?php echo RSCommentsHelper::route('index.php?option=com_rscomments&task=captcha&type=form'.$this->hash.'&sid='.uniqid('')); ?>" alt="" height="80" />
								...
								<input type="text" name="jform[captcha]" size="40" value="" class="span5 form-control <?php echo RSTooltip::tooltipClass(); ?> required" title="<?php echo RSTooltip::tooltipText($this->config->captcha_cases ? JText::_('COM_RSCOMMENTS_CAPTCHA_CASE_SENSITIVE') : JText::_('COM_RSCOMMENTS_CAPTCHA_CASE_INSENSITIVE')); ?>" />
							<?php } else { ?>
		...
		<div class="<?php echo RSCommentsAdapterGrid::row(); ?>">
			<div class="<?php echo RSCommentsAdapterGrid::column(12); ?>">
				...
				<button type="button" class="btn btn-secondary" data-rsc-task="preview"><?php echo JText::_('COM_RSCOMMENTS_PREVIEW'); ?></button>
				<?php } ?>
				...
				<button type="button" class="btn btn-secondary" data-rsc-task="reset"><?php echo JText::_('COM_RSCOMMENTS_RESET'); ?></button>
				<button type="button" class="btn btn-secondary rsc_cancel_btn" style="display:none;"><?php echo JText::_('COM_RSCOMMENTS_CANCEL'); ?></button>
			</div>
		</div>
