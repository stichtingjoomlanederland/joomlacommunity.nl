...
<form name="adminForm" id="adminForm" class="ebForm" action="index.php" method="post" data-ed-form>
	...
	<div class="app-filter-bar">
		<div class="app-filter-bar__cell t-w--100">
			<div class="app-filter-bar__filter-wrap t-ml--md">
				<?php echo JText::_('COM_EASYDISCUSS_LANGUAGES_INFO_NOTE'); ?>

				<a href="https://stackideas.com/docs/easydiscuss/administrators/translations/becoming-an-official-translator" class="o-btn o-btn--default-o o-btn--sm" target="_blank"><?php echo JText::_('COM_EASYDISCUSS_BE_TRANSLATOR'); ?></a>
			</div>
		</div>
	</div>
	...
	<?php echo $this->html('form.action', 'languages', 'languages'); ?>
</form>
