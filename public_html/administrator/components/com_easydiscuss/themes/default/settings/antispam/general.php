		...
		<div class="panel">
			...
			<div class="panel-body">
				<div class="form-horizontal">
					<?php echo $this->html('settings.textbox', 'antispam_minimum_title', 'COM_EASYDISCUSS_ANTI_SPAM_MINIMUM_TITLE', '', array('size' => 5, 'postfix' => 'Characters'), '', 'form-control-sm text-center'); ?>
