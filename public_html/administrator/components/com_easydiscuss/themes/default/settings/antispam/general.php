        ...
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
					...
					<?php echo $this->html('settings.textbox', 'antispam_disallow_editing_days', 'COM_ED_ANTISPAM_DISALLOW_EDITING_DAYS', '', array('size' => 8, 'postfix' => 'Days'), '', 'form-control-sm text-center'); ?>
