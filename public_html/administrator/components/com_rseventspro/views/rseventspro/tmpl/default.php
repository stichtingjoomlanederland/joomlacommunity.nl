...
<div class="<?php echo RSEventsproAdapterGrid::row(); ?>">
	<div class="<?php echo RSEventsproAdapterGrid::column(9); ?>">
		...
		<div class="<?php echo RSEventsproAdapterGrid::row(); ?>">
			<div class="<?php echo RSEventsproAdapterGrid::column(12); ?>">
				<div class="rsepro-box-container">
			...
			<div class="<?php echo RSEventsproAdapterGrid::column(12); ?>">
				...
				<table class="table">
					<thead>
						<tr>
							...
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_SUBSCRIBERS'); ?></th>
						</tr>
					</thead>
					<tbody>
					...
					<?php if (!$event->id) continue; ?>
						<tr>
							...
							<td class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo $event->subscribers; ?></td>
						</tr>
					<?php }} ?>
					</tbody>
				</table>
				...
				<table class="table">
					<thead>
						<tr>
							<th><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_EVENT'); ?></th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_SUBSCRIBER_NAME'); ?></th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_SUBSCRIBER_DATE'); ?></th>
						</tr>
					</thead>
					<tbody>
					...
					<?php foreach ($this->subscribers as $subscriber) { ?>
						<tr>
							...
							<td class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><a href="<?php echo JRoute::_('index.php?option=com_rseventspro&task=subscription.edit&id='.$subscriber->id); ?>"><?php echo $subscriber->name; ?></a></td>
				...
				<table class="table">
					<thead>
						<tr>
							<th><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_EVENT'); ?></th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_COMMENT_NAME'); ?></th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_COMMENT_DATE'); ?></th>
						</tr>
					</thead>
					<tbody>
					...
					<?php foreach ($this->comments as $comment) { ?>
						<tr>
							...
							<td class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo $comment->comment; ?></td>
				...
				<table class="table">
					<thead>
						<tr>
							<th>&nbsp;</th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_SUBSCRIBERS'); ?></th>
							<th class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo JText::_('COM_RSEVENTSPRO_DASHBOARD_TOTAL'); ?></th>
						</tr>
					</thead>
					<tbody>
					...
					<?php foreach ($this->statistics as $period => $data) { ?>
						<tr>
							...
							<td class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo $data->count; ?></td>
							<td class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?>"><?php echo rseventsproHelper::currency($data->total); ?></td>
						</tr>
					<?php }} ?>
					</tbody>
				</table>
	...
	<div class="<?php echo RSEventsproAdapterGrid::column(3); ?>">
		<ul class="<?php echo RSEventsproAdapterGrid::nav(); ?>">
			<li class="active">
			...
			<li>
				<a class="nav-link" href="<?php echo $button['link']; ?>">
