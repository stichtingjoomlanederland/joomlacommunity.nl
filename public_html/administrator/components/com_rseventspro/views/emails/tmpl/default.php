...
<form action="<?php echo JRoute::_('index.php?option=com_rseventspro&view=emails&tmpl=component'); ?>" method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal" autocomplete="off">
	...
	<div style="width:100%;text-align:right;">
		<button type="button" onclick="Joomla.submitbutton('email.add');" class="btn btn-primary"><?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_NEW_BTN'); ?></button>
		...
		<button type="button" onclick="window.parent.jQuery('#rseModal').modal('hide');" class="btn btn-danger"><?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_CANCEL_BTN'); ?></button>
	</div>
	<br />
	...
	<table class="table table-striped">
		<thead>
			...
			<th width="3%" class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?> hidden-phone"><?php echo JText::_('JGRID_HEADING_ID'); ?></th>
		</thead>
		<tbody>
