		...
		<div id="j-main-container" class="span10 j-main-container">
			...
			<table class="table table-striped">
				<thead>
					...
					<th width="40%" align="center" class="center"><?php echo JText::_('COM_RSEVENTSPRO_UNSUBSCRIBER_EMAIL'); ?></th>
					<th width="15%" align="center" class="center"><?php echo JHtml::_('searchtools.sort', 'COM_RSEVENTSPRO_UNSUBSCRIBER_DATE', 'date', $listDirn, $listOrder); ?></th>
				...
				<tbody>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td align="center" class="center"><?php echo $item->email; ?></td>
