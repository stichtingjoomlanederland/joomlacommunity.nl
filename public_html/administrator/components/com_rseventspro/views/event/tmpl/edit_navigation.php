...
<ul id="rsepro-edit-menu" class="<?php echo RSEventsproAdapterGrid::nav(true); ?>">
	<li class="nav-item"><a href="javascript:void(0);" data-toggle="modal" data-bs-toggle="modal" data-target="#rsepro-edit-event-photo" data-bs-target="#rsepro-edit-event-photo" class="<?php echo RSEventsproAdapterGrid::styles(array('center')); ?> nav-link" onclick="rsepro_reset_frame();"><?php echo $this->loadTemplate('icon'); ?></a></li>
	
	<?php if ($this->item->completed) { ?>
	<li class="nav-item"><a href="javascript:void(0);" data-target="#rsepro-edit-tabd" data-bs-target="#rsepro-edit-tabd" data-toggle="tab" data-bs-toggle="tab" class="nav-link"><?php echo JText::_('COM_RSEVENTSPRO_EVENT_TAB_DASHBOARD'); ?> <span class="fa fa-tachometer"></span></a></li>
	<?php } ?>
	...
	<li class="nav-item"><a class="nav-link" href="javascript:void(0);" data-target="#rsepro-edit-rsmail" data-bs-target="#rsepro-edit-rsmail" data-toggle="tab" data-bs-toggle="tab"><?php echo JText::_('COM_RSEVENTSPRO_EVENT_TAB_RSMAIL'); ?> <span class="fa fa-envelope-o"></span></a></li>
	<?php } ?>
