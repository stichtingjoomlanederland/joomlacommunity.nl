...
<label for="aspectratio" class="pull-left" style="display: none; width:auto;" id="aspectratiolabel">
...
<button class="btn btn-danger" data-dismiss="modal" data-bs-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_RSEVENTSPRO_GLOBAL_CANCEL_BTN'); ?></button>