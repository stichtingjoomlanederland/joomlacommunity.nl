...
<div id="rsc-installer-right">
	...
	<h2>Changelog v1.13.21</h2>
	<ul class="version-history">
		<li><span class="version-new">Add</span> Comments listing (backend) - show the title of the article where the comment was posted.</li>
		<li><span class="version-new">Add</span> Option to enable content plugins on comments.</li>
	</ul>
