...
<div id="rsc-installer-right">
	...
	<h2>Changelog v1.13.20</h2>
	<ul class="version-history">
		<li><span class="version-new">Add</span> Joomla! 4 compatibility.</li>
		<li><span class="version-new">Add</span> Invisible reCaptcha.</li>
		<li><span class="version-fixed">Fix</span> Miscellaneous code improvements.</li>
	</ul>
