...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="akeeba-form--horizontal">
	...
	<div class="akeeba-panel--primary">
		...
		<div class="akeeba-form-group">
			...
			<?php echo JHtml::_('FEFHelper.select.genericlist', Select::getCorsOptions(), 'cors', ['list.select' => $config->cors]); ?>
		</div>
		...
		<div class="akeeba-form-group">
			...
			<?php echo Select::etagtype('etagtype', ['class' => 'input-medium'], $config->etagtype); ?>
		</div>
	...
	<div class="akeeba-panel--primary">
		...
		<div class="akeeba-form-group">
			...
			<?php echo Select::symlinks('symlinks', ['class' => 'input-medium'], $config->symlinks); ?>
		</div>
