...
<div class="akeeba-block--info">
	<p>
		<strong>
			<?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WILLTHISWORK'); ?>
		</strong>
	</p>
	<p>
		<?php if ($this->isSupported == 0): ?>
			<?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WILLTHISWORK_NO'); ?>
		<?php elseif ($this->isSupported == 1): ?>
			<?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WILLTHISWORK_YES'); ?>
		<?php else: ?>
			<?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WILLTHISWORK_MAYBE'); ?>
		<?php endif; ?>
	</p>
</div>

<div class="akeeba-block--warning">
	<h3><?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WARNING'); ?></h3>

	<p><?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_WARNTEXT'); ?></p>

	<p><?php echo Text::_('COM_ADMINTOOLS_LBL_WEBCONFIGMAKER_TUNETEXT'); ?></p>
</div>
...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="akeeba-form--horizontal">
	...
	<div class="akeeba-panel--primary">
		...
		<div class="akeeba-form-group">
			<label for="noserversignature"><?php echo Text::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_NOSERVERSIGNATURE'); ?></label>

			<?php echo HTMLHelper::_('FEFHelper.select.booleanswitch', 'noserversignature', $config->noserversignature); ?>
		</div>
	...
	<div class="akeeba-panel--primary">
		...
		<div class="akeeba-form-group">
			<label for="frontendprot"><?php echo Text::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_FRONTENDPROT'); ?></label>
	...
	<div class="akeeba-panel--primary">
		...
		<div class="akeeba-form-group">
			<label for="autoroot"><?php echo Text::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_AUTOROOT'); ?></label>

			<?php echo HTMLHelper::_('FEFHelper.select.booleanswitch', 'autoroot', $config->autoroot); ?>
		</div>
		...
		<div class="akeeba-form-group">
			<label for="httpsurls"><?php echo Text::_('COM_ADMINTOOLS_LBL_HTACCESSMAKER_HTTPSURLS'); ?></label>
		...
		<div class="akeeba-form-group">
			...
			<?php echo Select::etagtypeIIS('etagtype', ['class' => 'input-medium'], $config->etagtype); ?>
		</div>
