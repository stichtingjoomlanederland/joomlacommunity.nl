...
<div id="admintools-whatsthis" class="akeeba-block--info">
	<p><?php echo Text::_('COM_ADMINTOOLS_LBL_EXCEPTIONSFROMWAF_WHATSTHIS_LBLA') ?></p>
	<ul>
		<li><?php echo Text::_('COM_ADMINTOOLS_LBL_EXCEPTIONSFROMWAF_WHATSTHIS_LBLB') ?></li>
		<li><?php echo Text::_('COM_ADMINTOOLS_LBL_EXCEPTIONSFROMWAF_WHATSTHIS_LBLC') ?></li>
	</ul>
</div>
