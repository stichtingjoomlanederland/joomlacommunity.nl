...
use Akeeba\AdminTools\Admin\Model\WAFBlacklistedRequests;
...
/** @var WAFBlacklistedRequests $item */
$item = $this->getItem();
		...
		<div>
			...
			<div class="akeeba-form-group">
				<label for="application">
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_APPLICATION'); ?>
				</label>

				<?php echo Select::wafApplication('application', null, $item->application) ?>
				<p>
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_APPLICATION_DESC') ?>
				</p>
			</div>

			<div class="akeeba-form-group">
				<label for="verb">
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_VERB'); ?>
				</label>

				<?php echo Select::httpVerbs('verb', null, $item->verb) ?>
				<p>
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_VERB_TIP') ?>
				</p>
			</div>
			...
			<div class="akeeba-form-group">
				<label for="ftask">
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_TASK'); ?>
				</label>

				<input type="text" name="ftask" id="ftask" value="<?php echo $this->escape($item->ftask); ?>" />

				<p>
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_TASK_TIP') ?>
				</p>
			</div>
			...
			<div class="akeeba-form-group">
				<label for="query_content">
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_QUERY_CONTENT'); ?>
				</label>

				<input type="text" name="query_content" id="query_content"
					   value="<?php echo $this->escape($item->query_content); ?>" />

				<p>
					<?php echo Text::_('COM_ADMINTOOLS_LBL_WAFBLACKLISTEDREQUEST_QUERY_CONTENT_TIP') ?>
				</p>
			</div>
		</div>
	</div>
