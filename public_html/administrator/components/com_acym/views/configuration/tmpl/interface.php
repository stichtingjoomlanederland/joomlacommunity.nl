...
?><div class="acym__content acym_area padding-vertical-1 padding-horizontal-2 margin-bottom-2">
	...
	<div class="grid-x grid-margin-x">
        <?php echo acym_switch('config[small_display]', $data['config']->get('small_display'), acym_translation('ACYM_COMPACT_DISPLAY'), array(), 'xlarge-3 medium-5 small-9', "auto", "tiny"); ?>
	</div>
</div>
