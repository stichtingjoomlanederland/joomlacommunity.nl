...
?><?php
$isSent = acym_escape($data['campaignInformation']->sent);
?>
        ...
        <div class="cell acym__content xxlarge-6 large-9">
            ...
            <div id="acym__campaign__summary" class="grid-x grid-margin-y">
                <div class="cell grid-x acym__campaign__summary__section margin-right-2">
                    ...
                    <?php if (!$isSent) { ?>
                        <div class="cell auto acym__campaign__summary__modify">
                            <a href="<?php echo acym_completeLink('campaigns&task=edit&step=editEmail&edition=1&id='.acym_escape($data['campaignInformation']->id)); ?>"><i class="fa fa-pencil"></i><span> <?php echo acym_translation('ACYM_EDIT'); ?></span></a>
                        </div>
                    <?php } ?>
                    <div class="cell grid-x grid-margin-y">
                        ...
                        <p class="cell medium-6 acym__campaign__summary__email__information">
                            <?php echo acym_translation('ACYM_SUBJECT'); ?>: <span class="acym__color__blue"><?php echo acym_escape($data['mailInformation']->subject); ?></span>
                        </p>
                    </div>
                ...
                <div class="cell grid-x acym__campaign__summary__section">
                    ...
                    <?php if (!$isSent) { ?>
                        <div class="cell auto acym__campaign__summary__modify">
                            <a href="<?php echo acym_completeLink('campaigns&task=edit&step=recipients&edition=1&id='.acym_escape($data['campaignInformation']->id)); ?>"><i class="fa fa-pencil"></i><span> <?php echo acym_translation('ACYM_EDIT'); ?></span></a>
                        </div>
                    <?php } ?>
                ...
                <div class="cell grid-x grid-margin-y acym__campaign__summary__section">
                    ...
                    <?php if (!$isSent) { ?>
                        <div class="cell auto acym__campaign__summary__modify">
                            <a href="<?php echo acym_completeLink('campaigns&task=edit&step=sendSettings&edition=1&id='.acym_escape($data['campaignInformation']->id)); ?>"><i class="fa fa-pencil"></i><span> <?php echo acym_translation('ACYM_EDIT'); ?></span></a>
                        </div>
                    <?php } ?>
                    <div class="cell grid-x grid-margin-x">
                        ...
                        <p class="cell auto">
                            ...
                            $output = '';
                            if ($isSent) {
                                $output .= acym_translation_sprintf('ACYM_THIS_CAMPAIGN_HAS_BEEN_SENT_ON_AT', '<b>'.acym_date(acym_escape($data['campaignInformation']->sending_date), 'F j, Y').'</b>', '<b>'.acym_date(acym_escape($data['campaignInformation']->sending_date), 'H:i').'</b>');
                            } else if ($data['campaignType'] == 'scheduled') {
                                $output .= acym_translation_sprintf('ACYM_THIS_CAMPAIGN_WILL_BE_SENT_ON_AT', '<b>'.acym_date(acym_escape($data['campaignInformation']->sending_date), 'F j, Y').'</b>', '<b>'.acym_date(acym_escape($data['campaignInformation']->sending_date), 'H:i').'</b>');
                            } else {
