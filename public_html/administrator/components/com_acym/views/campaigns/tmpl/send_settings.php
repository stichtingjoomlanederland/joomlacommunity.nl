        ...
        <div id="acym__campaigns" class="acym__content text-center xxlarge-6 large-9 grid-x cell">
            ...
            <div class="cell grid-x acym__campaign__sendsettings__from-settings">
                <div class="cell large-5 medium-5">
                    ...
                    <input type="text" class="cell" value="<?php echo acym_escape($data['senderInformations']->from_name); ?>" name="senderInformation[from_name]" placeholder="<?php echo acym_escape($data['senderInformations']->from_name) == '' ? empty($data['config_values']->from_name) ? 'Default Value' : 'Default : '.acym_escape($data['config_values']->from_name) : ''; ?>">
                </div>
                ...
                <div class="cell large-5 medium-5">
                    ...
                    <input type="email" class="cell" value="<?php echo acym_escape($data['senderInformations']->from_email); ?>" name="senderInformation[from_email]" placeholder="<?php echo acym_escape($data['senderInformations']->from_email == '' ? empty($data['config_values']->from_email) ? 'Default Value' : 'Default : '.acym_escape($data['config_values']->from_email) : ''); ?>">
                </div>
            </div>
                ...
                <div class="grid-x cell">
                    ...
                    <div class="cell grid-x acym__campaign__sendsettings__display-send-type-scheduled">
                        ...
                        <label class="cell large-5" for="acym__campaign__sendsettings__send">
                            <?php
                            $value = !empty($data['currentCampaign']->sending_date) ? acym_date(acym_escape($data['currentCampaign']->sending_date), 'd M Y H:i') : '';
