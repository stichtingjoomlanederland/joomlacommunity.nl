...
?>
<form action="<?php echo Route::_('index.php?option=com_pwtsitemap&view=menus'); ?>" method="post" name="adminForm"
      id="adminForm">
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								<a href="<?php echo Route::_('index.php?option=com_pwtsitemap&view=menu&layout=edit&id=' . $item->id); ?>">
									<?php echo ($item->custom_title === '' || $item->custom_title === null) ? '-' : $this->escape($item->custom_title); ?> (<?php echo $this->escape($item->title); ?>)</a>
								<div class="small">
