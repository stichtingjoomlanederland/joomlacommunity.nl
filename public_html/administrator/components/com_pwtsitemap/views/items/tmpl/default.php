...
<form action="<?php echo Route::_('index.php?option=com_pwtsitemap&view=items'); ?>" method="post" name="adminForm"
      id="adminForm">
					...
					<?php foreach ($this->items as $i => $item):
						...
						<tr sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->id; ?>"
							...
							<td>
								...
								<?php echo HTMLHelper::_('select.genericlist', $elements, 'robots_' . $item->id, 'class="pwtrobots advancedSelect"', 'value', 'text', $robots); ?>
