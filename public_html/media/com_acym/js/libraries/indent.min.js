!function (n, t) {
    'function' == typeof define && define.amd ? define([], t) : 'object' == typeof exports ? module.exports = t() : n.indent = t();
}(this, function () {
    var n = function (n) {
        function t(n, t) {
            var e, r = [];
        ...
        function a(n, a, o) {
            ...
            function m(n, r, a) {
                ...
                for (var l, s, i, c = null, u = n.length, o = F[F.length - 1], h = o ? o.rule.b : '', d = t(Z, function (n) {
                    return n.rule.b;
                }).join('\n'), m = 0 ; m < r.length ; m++) {
                    i = r[m], i.h && e(i.h, function (n) {
