ed.define('iconpicker', ['edjquery'], function($) {
...
(function(e) {
	...
	if (typeof define === "function" && define.amd) {
		define([ "jquery" ], e);
	} else if (window.edjquery && !window.edjquery.fn.iconpicker) {
		e(window.edjquery);
	}
})(function(c) {
	"use strict";
	...
	t.defaultOptions = {
		...
		templates: {
			...
			search: '<input type="search" class="o-form-control iconpicker-search" placeholder="Type to filter" />',
			iconpicker: '<div class="iconpicker"><div class="iconpicker-items "></div></div>',
			iconpickerItem: '<a role="button" href="javascript:;" class="iconpicker-item o-btn o-btn--outline-default o-btn--sm"><i></i></a>'
		}
	};
