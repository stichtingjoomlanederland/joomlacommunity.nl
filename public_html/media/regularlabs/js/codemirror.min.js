 ...
 */
"use strict";if(typeof window.RegularLabsCodeMirror==='undefined'||typeof RegularLabsCodeMirror.version==='undefined'||RegularLabsCodeMirror.version<'21.6.1331'){(function($){window.RegularLabsCodeMirror={version:'21.6.1331',init:function(id){if(!$(`#rl_codemirror_${id}.CodeMirror`).length){setTimeout(function(){RegularLabsCodeMirror.init(id);},100);return;}
