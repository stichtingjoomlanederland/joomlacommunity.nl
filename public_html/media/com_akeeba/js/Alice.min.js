...
"------ BEGIN OF ALICE RAW OUTPUT -----\n",c=0;c<a.length;c++)d=a[c],b+="[b]"+d.check+"[/b]\n"+d.error+"\n\n";h.querySelector("textarea").innerHTML=b+"------ END OF ALICE RAW OUTPUT -----\n";h.style.display="block"}}})},onError:function(a){document.getElementById("alice-error-message").innerHTML=a.Error}})).init();return!1});akeeba.System.triggerEvent(c,"change");document.getElementById("log").options[document.getElementById("log").selectedIndex].value&&akeeba.System.triggerEvent(f,"click")}); //# sourceMappingURL=Alice.min.map
