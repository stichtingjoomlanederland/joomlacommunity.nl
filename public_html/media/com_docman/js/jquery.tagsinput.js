	...
	$.fn.addTag = function(value,options) {
			...
			this.each(function() { 
				...
				if (value !='' && skipTag != true) {
                    var element = $('<a>')
                    	.css({'opacity': options.animate ? 0.1 : 1, 'margin-top': '7px'})
                    	.addClass('tag k-button k-button--default k-button--small k-add-tag')
                    	.attr('data-tag', value)
                    	.append(value)
    ...
    var settings = kQuery.extend({
      ...
      inputPadding: 6*2
		...
		this.each(function() { 
			...
			markup = markup + '<div id="'+id+'_tagsinput" class="k-form-group">';
			if (settings.interactive) {
				markup = markup + '<input type="text" class="k-form-control" id="'+id+'_tag" value="" data-default="'+settings.defaultText+'" />';
			}
			
			markup = markup + '<div id="'+id+'_addTag"></div></div>';
