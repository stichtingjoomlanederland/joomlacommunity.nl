            ...
            <div class="ed-list__item">
                <div class="ed-list__item-group">
                    ...
                    <?php if (!$params->get('exclude_child_categories', false) && $category->totalSubcategories) { ?>
                        <a data-ed-toggle="collapse" href="#collapse-cat-<?php echo $category->id; ?>" class="ed-list__toggle">
                    ...
                    <?php if (!$params->get('exclude_child_categories', false) && $category->totalSubcategories) { ?>
                        <div class="ed-list__item-group-bd collapse in" id="collapse-cat-<?php echo $category->id; ?>">
                            <div class="ed-tree">
