...
class SPUpgradeModelCom_Virtuemart extends SPUpgradeModelExtension {
    ...
    private function fix($pks = null, $name) {
        ...
        foreach ($pks as $pk) {
            ...
            if (!empty($locked_by)) {
                $tableLog->reset();
                $tableLog->id = null;
                $tableLog->load(array("tables_id" => 1, "source_id" => $locked_by));
                $item['locked_by'] = $tableLog->destination_id;
            }
