...
class SPUpgradeModelCom_PhocaGallery extends SPUpgradeModelExtension {
    ...
    private function fix($pks = null, $name) {
        ...
        foreach ($pks as $pk) {
            ...
            if (!empty($owner_id)) {
                $tableLog->reset();
                $tableLog->id = null;
                $tableLog->load(array("tables_id" => 1, "source_id" => $owner_id));
                $item['owner_id'] = $tableLog->destination_id;
            }
            ...
            if (!empty($created_by)) {
                $tableLog->reset();
                $tableLog->id = null;
                $tableLog->load(array("tables_id" => 1, "source_id" => $accessuserid));
                $item['accessuserid'] = $tableLog->destination_id;
            }
            ...
            if (!empty($created_by)) {
                $tableLog->reset();
                $tableLog->id = null;
                $tableLog->load(array("tables_id" => 1, "source_id" => $uploaduserid));
                $item['uploaduserid'] = $tableLog->destination_id;
            }
            ...
            if (!empty($created_by)) {
                $tableLog->reset();
                $tableLog->id = null;
                $tableLog->load(array("tables_id" => 1, "source_id" => $deleteuserid));
                $item['deleteuserid'] = $tableLog->destination_id;
            }
