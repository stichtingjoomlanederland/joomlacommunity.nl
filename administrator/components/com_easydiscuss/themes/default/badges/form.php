				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" id="datepicker" class="input-large" name="created" value="<?php echo ED::date($badge->created)->display('%A, %B %d %Y'); ?>" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-5 control-label">
						...
						<div class="form-group">
							...
							<ul class="badges-list unstyled pull-left clearfix">
								<?php foreach ($badges as $item) { ?>
									<li class="badge-item <?php echo $badge->avatar == $item ? ' selected-badge' : '';?>">
