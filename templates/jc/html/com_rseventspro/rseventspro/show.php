...
<div id="rs_event_show">
	...
	<!-- Admin options -->
		...
		<div class="btn-group">
			<button data-toggle="dropdown" class="btn btn-default dropdown-toggle">
				...
				<?php if (!$this->eventended) { ?><span class="fa fa-envelope fa-fw"></span><?php } ?>
				<?php if ($this->report) { ?><span class="fa fa-flag fa-fw"></span><?php } ?>
	...
	<!--//end Admin options -->
		...
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&layout=edit&id='.rseventsproHelper::sef($event->id,$event->name)); ?>" class="btn btn-default ">
			<i class="fa fa-pencil fa-fw"></i> <?php echo JText::_('COM_RSEVENTSPRO_EVENT_EDIT'); ?>
		</a>
		<?php } ?>
	...
	<!-- Invite/Join/Unsubscribe -->
		...
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&layout=subscribe&id='.rseventsproHelper::sef($event->id,$event->name).$tmpl); ?>" class="btn btn-default <?php echo $class; ?>"<?php echo $rel_s; ?> >
		...
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&task=rseventspro.unsubscribe&id='.rseventsproHelper::sef($event->id,$event->name)); ?>" class="btn btn-default ">
		...
		<a href="<?php echo rseventsproHelper::route('index.php?option=com_rseventspro&layout=unsubscribe&id='.rseventsproHelper::sef($event->id,$event->name).'&tmpl=component'); ?>" class="btn btn-default  <?php echo $Uclass; ?>" <?php echo $Urel; ?>>
			<i class="fa fa-times fa-fw"></i> <?php echo JText::_('COM_RSEVENTSPRO_EVENT_UNSUBSCRIBE'); ?>
		</a>
		<?php } ?>
		<?php } ?>
		...
		<div class="btn-group">
			<!-- Removed Sentence based display and added icons + added btn-default:: ConConNL-->
			<button data-toggle="dropdown" class="btn btn-default dropdown-toggle">
				<?php if (!$this->eventended && !empty($this->options['show_invite'])) { ?><span class="fa fa-plus fa-fw"></span><?php } ?>
				<?php if ($this->report) { ?><span class="fa fa-flag fa-fw"></span><?php } ?>
				<?php if (!empty($this->options['show_print'])) { ?><span class="fa fa-print fa-fw"></span><?php } ?>
				<?php if (!empty($this->options['show_export'])) { ?><span class="fa fa-calendar fa-fw"></span><?php } ?>
				<?php if ($this->config->timezone) { ?><span class="fa fa-clock-o fa-fw"></span><?php } ?>
