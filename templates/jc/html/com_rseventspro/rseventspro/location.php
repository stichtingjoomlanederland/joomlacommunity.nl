...
<div class="rsepro-location-content well">
		...
		<?php if (rseventsproHelper::getConfig('google_map_directions')) { ?>
			<div style="margin:15px 0;">
				...
				<div class="input-group">
					<input type="text" size="25" id="rsepro-directions-from" name="rsepro-directions-from" value="" class="form-control" />
					<span class="input-group-btn">
						<button id="rsepro-get-directions" type="button" class="button btn btn-default"><?php echo JText::_('COM_RSEVENTSPRO_LOCATION_GET_DIRECTIONS'); ?></button>
					</span>
				</div>
			</div>
