...
<div class="discussPostsList" data-view="categories" data-id="<?php echo $category->id; ?>">
	...
	<?php if( !empty( $category->posts ) || !empty( $category->featured ) ){ ?>
		<?php if( !empty( $category->featured ) ){ ?>
			<div class="well">
			<ul class="forum-replies list-featured reset-ul" itemscope itemtype="http://schema.org/ItemList">
	...
	<div class="well">
	<?php if( !empty( $category->posts ) || empty( $category->featured ) ){ ?>
	<ul class="forum-replies normal clearfix" itemscope itemtype="http://schema.org/ItemList">
