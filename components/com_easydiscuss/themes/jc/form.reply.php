...
echo $layout->render($system->my->id);
?>
					...
					<?php } ?>
						...
						<input type="button" name="submit-reply" class="btn btn-success btn-large submit-reply" value="<?php echo JText::_('COM_EASYDISCUSS_BUTTON_SUBMIT_RESPONSE'); ?>" onclick="discuss.reply.submit('<?php echo $composer->id; ?>');return false;" />
