...
<?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_HAS_ASSIGNED_TO_THIS_DISCUSSION' ); ?><br />
<br />
...
<div style="padding:20px;border-top:1px solid #ccc;padding:20px 0 10px;margin-top:20px;line-height:19px;color:#555;font-family:'Lucida Grande',Tahoma,Arial;font-size:12px;text-align:left">
	...
	style="background-color:#ffcc00;border:1px solid #caa200;padding-left:15px;padding-right:15px;border-radius:2px;color:#534200;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:30px;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;" target="_blank"><?php echo JText::_( 'COM_EASYDISCUSS_EMAILTEMPLATE_VISIT_LINK_HERE' );?> &nbsp; &raquo;</a>
	<![endif]>
	</div>
</div>
