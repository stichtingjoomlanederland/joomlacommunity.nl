...
if( $system->config->get( 'enable_subscription' ) && ( !$system->my->guest || $system->config->get( 'show_email' ) > 0 ) && !$system->config->get( 'subscription_auto' ) ) {
	...
	<div class="subscribeForm kmt-form-subscription<?php if( $subscribed !== null ) echo 'subscribed '; ?>">
	...
	<?php } else { ?>
		<div class="checkbox checkbox-primary">
			<input type="checkbox" name="subscribe-checkbox" id="subscribe-checkbox" value="y" class="subscribeCheckbox" <?php if( $subscribed !== null ) echo 'checked '; ?>/>
