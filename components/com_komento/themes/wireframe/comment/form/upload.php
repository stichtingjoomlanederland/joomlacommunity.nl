		...
		<div class="kmt-upload-area uploaderForm">
			...
			<div id="uploadArea" class="kmt-upload-push uploadArea clearfix">
				<span class="uploadClick kmt-has-tip">
					<a class="uploadButton input button" type="button" href="javascript:void(0);">
						<?php // echo JText::_( 'COM_KOMENTO_FORM_ATTACH_FILE' ); ?>
						<?php echo JText::_( 'Files' ); ?>
					</a>
					<span class="kmt-tip hidden">
						<i></i>
						<span>
							...
							<div class="uploadLimit"><span class="fileCounter">0</span> / <?php echo $system->config->get( 'upload_max_file' ); ?></div>
						</span>
					</span>
				</span>
