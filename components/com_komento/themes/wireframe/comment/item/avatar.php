...
<div class="kmt-thumb"<?php if( $system->konfig->get( 'enable_schema' ) ) echo ' itemprop="creator" itemscope itemtype="http://schema.org/Person"'; ?>
...
>
	<?php if( $system->config->get( 'layout_avatar_integration' ) == 'gravatar' || !$row->author->guest ) { ?>
		<a href="<?php echo $row->author->getProfileLink( $row->email ); ?>"<?php if( $system->konfig->get( 'enable_schema' ) ) echo ' itemprop="url"'; ?> class="kmt-avatar">
	<?php } ?>
