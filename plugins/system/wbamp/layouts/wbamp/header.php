...
<nav
	...
	<a class="wbamp-site-logo"
	   href="<?php echo empty($displayData['site_link']) ? '/' : $this->escape(WbampHelper_Route::absolutify($displayData['site_link'])); ?>">
		<?php if (!empty($displayData['site_image'])) : ?>
			<amp-img
				src="<?php echo $this->escape(WbampHelper_Route::absolutify($displayData['site_image'])); ?>"
